...
{
    internal sealed class DGameOverGUI : DGUI
    {
        ...
        private readonly sbyte yFinalPosition = -(DScreenConstants.GAME_HEIGHT + 2);
        ...
        internal DGameOverGUI(string identifier, DAssetDatabase assetDatabase, DGUIManager guiManager, DGameInformation gameInformation) : base(identifier)
        {
