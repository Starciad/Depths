...
{
    internal sealed class VictoryGUI : GUI
    {
        ...
        internal VictoryGUI(string identifier, AssetDatabase assetDatabase, GameInformation gameInformation, GUIManager guiManager) : base(identifier)
        {
            ...
            this.panelElement = new()
            {
                ...
                Texture = assetDatabase.GetTexture("texture_gui_7")
            };
        }
