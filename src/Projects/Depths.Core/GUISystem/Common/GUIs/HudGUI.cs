...
{
    internal sealed class HudGUI : GUI
    {
        // ========================= //
        ...
        private readonly int centerTextYAnchorPosition = ScreenConstants.GAME_HEIGHT / 2;
        private readonly int bottomTextYAnchorPosition = ScreenConstants.GAME_HEIGHT - FontConstants.HEIGHT;

        private readonly GUITextElement topTextElement;
        private readonly GUITextElement centerTextElement;
        private readonly GUITextElement bottomTextElement;

        private readonly TextManager textManager;
        private readonly GUIManager guiManager;
        private readonly GameInformation gameInformation;

        internal HudGUI(string identifier, TextManager textManager, GUIManager guiManager, GameInformation gameInformation) : base(identifier)
        {
            ...
            {
                IsVisible = false,
                Position = new(ScreenConstants.GAME_WIDTH / 2, 0),
            };
        ...
        private static void ResetTextElement(GUITextElement textElement, int yPosition, ref byte textVisibilityFrameCounter)
        {
        ...
        private void Player_OnCollectedOre(Ore ore)
        {
        ...
        private void Player_OnTriedMineToughBlock(Tile tile)
        {
            ResetTextElement(this.bottomTextElement, this.bottomTextYAnchorPosition, ref this.bottomTextVisibilityFrameCounter);
            this.bottomTextElement.SetValue(string.Concat("Req. Power ", tile.Resistance));
        }

        private void Player_OnTriedMineIndestructibleBlock(Tile tile)
        {
            ResetTextElement(this.bottomTextElement, this.bottomTextYAnchorPosition, ref this.bottomTextVisibilityFrameCounter);
            this.bottomTextElement.SetValue("Unbreak Block");
        }

        private void Player_OnCollectedItemFromBox(BoxItem boxItem, uint quantityObtained)
        {
            ResetTextElement(this.centerTextElement, this.centerTextYAnchorPosition, ref this.centerTextVisibilityFrameCounter);
            ResetTextElement(this.bottomTextElement, this.bottomTextYAnchorPosition, ref this.bottomTextVisibilityFrameCounter);
