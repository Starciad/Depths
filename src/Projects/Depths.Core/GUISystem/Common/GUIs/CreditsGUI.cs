...
{
    internal sealed class CreditsGUI : GUI
    {
        ...
        private readonly GUITextElement textElement;
        private readonly GUIImageElement backgroundImageElement;
        private readonly GUIImageElement truckImageElement;
        private readonly GUIImageElement idolImageElement;
        ...
        internal CreditsGUI(string identifier, AssetDatabase assetDatabase, GameInformation gameInformation, GUIManager guiManager, InputManager inputManager, MusicManager musicManager, TextManager textManager) : base(identifier)
        {
            ...
            this.truckImageElement = new()
            {
                ...
                TextureClipArea = SpriteConstants.TRUCK_SOURCE_RECTANGLES[0],
            };
            ...
            {
                this.backgroundSourceRectangles[i] = new(new(0, i * ScreenConstants.GAME_HEIGHT), new(ScreenConstants.GAME_WIDTH, ScreenConstants.GAME_HEIGHT));
            }
        ...
        internal override void Load()
        {
            ...
            this.idolImageElement.TextureClipArea = SpriteConstants.IDOL_SOURCE_RECTANGLES[this.gameInformation.IdolHeadSpriteIndex];
        }
        ...
        private void UpdateAnimations()
        {
            ...
            {
                this.truckAnimationIndex = (byte)((this.truckAnimationIndex + 1) % SpriteConstants.TRUCK_SOURCE_RECTANGLES.Length);
                this.truckImageElement.TextureClipArea = SpriteConstants.TRUCK_SOURCE_RECTANGLES[this.truckAnimationIndex];
                this.truckAnimationFrameCounter = 0;
            }
