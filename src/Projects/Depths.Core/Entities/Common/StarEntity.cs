...
{
    internal sealed class StarEntityDescriptor : EntityDescriptor
    {
        internal StarEntityDescriptor(string identifier, Texture2D texture, World.World world) : base(identifier, texture, world)
        {
        ...
        {
            return new StarEntity(this);
        }
    }

    internal sealed class StarEntity : Entity
    {
        ...
        internal StarEntity(EntityDescriptor descriptor) : base(descriptor)
        {
